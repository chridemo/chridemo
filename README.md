...
Security researcher and penetration tester focused on offensive security, vulnerability assessment, and security infrastructure. Specialized in web application security, network penetration testing, and security automation.
...
**Security Domains**
- Web Application Security — OWASP Top 10, API security, authentication/authorization flaws
- Network Penetration Testing — Active reconnaissance, port scanning, service enumeration, exploitation chains
- Malware Analysis — Static analysis, behavioral analysis, reverse engineering binaries
- Cloud & Container Security — AWS/Azure misconfiguration, Docker escape techniques, Kubernetes security
...
- Developing custom exploit frameworks and security tools in Python
- Advanced malware analysis and reverse engineering
- Cloud infrastructure security assessments
- Security automation and tooling for penetration testing workflows
...
Always authorized. Always responsible. Always learning.
